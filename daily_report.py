...
SCENARIO_DEFS = [
    ('01','BLOWOUT #1 - MJ',                           'CLEAR FADE', s01),
    ('02','BLOWOUT #2 - MJ',                           'CLEAR FADE', s02),
    ('03','BLOWOUT #3 - MJ',                           'INCONSISTENT', s03),
    ('04','THE BIG UPSET #1 - MJ',                     'CLEAR FADE', s04),
    ...
    ('13','THE HOT TEAMS MATCHUP #2 - MJ',             'CLEAR FADE', s13),
    ...
    ('17','THE PUMMELED PITCHERS #1 - MJ',             'CLEAR FADE', s17),
    ('18','THE PUMMELED PITCHERS #2 - MJ',             'CLEAR FADE', s18),
    ('19','THE PUMMELED PITCHERS #3 - MJ',             'CLEAR FADE', s19),
    ('20','3-GAME WIN STREAK / NEW SERIES - SM',       'INCONSISTENT', s20),
    ('21','3-GAME LOSING STREAK / LAST SERIES - SM',   'INCONSISTENT', s21),
    ('22','SMALL ROAD FAVORITE / NEW SERIES - SM',     'INCONSISTENT', s22),
    ('23','ROAD DOG / LAST GAME OF SERIES - SM',       'INCONSISTENT', s23),
    ('24','ROAD DOG / LAST GAME OF ROAD TRIP - SM',    'INCONSISTENT', s24),
    ...
    ('32','COLD HOME DOG / DIV. GAME',                 'CLEAR FADE', s32),
